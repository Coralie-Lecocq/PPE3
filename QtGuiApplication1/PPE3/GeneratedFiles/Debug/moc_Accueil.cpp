...
QT_MOC_LITERAL(1, 8, 15), // "ChangementPages"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Accueil\0ChangementPages\0"
};
...
void Accueil::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ChangementPages((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Accueil::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Accueil::ChangementPages)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Accueil::ChangementPages(int _t1)
{
